package net.reversteam.tagfixes;
...
@Mod("tagfixes")
public class TagfixesMod {
	public static final Logger LOGGER = LogManager.getLogger(TagfixesMod.class);
	public static final String MODID = "tagfixes";
